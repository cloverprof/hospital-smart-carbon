...
export const roleMeta: Record<RoleId, { name: string; desc: string; defaultRoute: string }> = {
  ...
  department: { name: "科室负责人", desc: "本科室单位业务量能耗与整改确认", defaultRoute: "/app/portal" },
...
// 17 个二级模块注册表。roles = 关闭「全部权限」时可见的角色。
export const modules: ModuleDef[] = [
  ...
  { id: "portal", categoryId: "cockpit", name: "功能门户", route: "/app/portal", icon: "LayoutGrid", summary: "六大板块 17 模块工作入口", roles: ["leader", "logistics", "department", "energyAdmin"] },
];
